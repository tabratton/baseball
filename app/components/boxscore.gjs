      ...
      <table class="table-auto text-center border-2 border-stone-50 w-full">
        <thead>
          <tr class="bg-stone-800 border-b-2 border-stone-50">
            <th class="text-left p-2 border-r-2 border-stone-50">{{t (concat "status." @game.statusCode)}}</th>
        ...
        <tbody>
          <tr class="{{@game.awayTeam.bgClass}} {{@game.awayTeam.textClass}}">
            ...
            {{/each}}
            <td class="px-2 py-1 border-l-2 border-stone-50 font-bold">{{@game.awayTeam.runs}}</td>
          ...
          <tr class="{{@game.homeTeam.bgClass}} {{@game.homeTeam.textClass}}">
            ...
            {{#each @game.homeTeam.innings as |inning|}}
              <td class="px-2 py-1">{{withDefault inning.runs (if @game.isOver "x" "")}}</td>
            {{/each}}
            <td class="px-2 py-1 border-l-2 border-stone-50 font-bold">{{@game.homeTeam.runs}}</td>
