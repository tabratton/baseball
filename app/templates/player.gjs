...
<template>
  ...
  <div class="h-home w-full overflow-auto">
    <div class="bg-stone-800 p-4 rounded">
      <div class="font-bold text-2xl text-center">{{@model.firstName}}
        {{@model.nickname}}
        {{@model.lastName}}
        -
        {{@model.number}}</div>
      <div class="flex gap-12 mt-4 justify-center">
        <div class="flex flex-col">
          <div class="flex justify-between gap-4">
            <span>Bats</span>
            <span>{{@model.bats}}</span>
          </div>
          <div class="flex justify-between gap-4">
            <span>Throws</span>
            <span>{{@model.throws}}</span>
          </div>
          <div class="flex justify-between gap-4">
            <span>Height</span>
        ...
        <div class="flex flex-col">
          ...
          <div class="flex justify-between gap-4">
            <span>MLB Debut</span>
            <span>{{@model.mlbDebut}}</span>
          </div>
        </div>
      </div>
      <Nav
        @selected={{@controller.selectedTab}}
        @onUpdate={{fn (mut @controller.selectedTab)}}
        as |nav|
      >
        <nav.Tab @tab="hitting">
          Hitting
        ...
        {{#if @controller.hasPitchingStats}}
      ...
      <div class="mt-4 overflow-auto relative">
        {{#if (eq @controller.selectedTab "hitting")}}
          <SortableTable
            class="player-table border-collapse border-none mb-4 mx-auto"
            @headers={{@controller.hittingHeaders}}
            @items={{@model.seasonHittingStats}}
          >
            <:header as |h|>
              <h.Header
                class="border-none
            ...
            <:default>
              <tr>
                ...
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.gamesPlayed}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.plateAppearances}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.atBats}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.avg}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.hits}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.doubles}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.triples}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.homeRuns}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.rbi}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.runs}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.baseOnBalls}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.strikeOuts}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.obp}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.slg}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.ops}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.babip}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.stolenBases}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.stolenBasePercentage}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.intentionalWalks}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.hitByPitch}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.groundIntoDoublePlay}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.totalBases}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.sacFlies}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.sacBunts}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.hitting.stat.atBatsPerHomeRun}}</td>
              </tr>
            </:default>
          </SortableTable>
        {{else if (eq @controller.selectedTab "fielding")}}
          <SortableTable
            class="player-table border-collapse border-none mb-4 mx-auto"
            @headers={{@controller.fieldingHeaders}}
            @items={{@model.seasonFieldingStats}}
          >
            <:header as |h|>
              <h.Header
                class="border-none
            ...
            <:default>
              {{#each @model.careerStats.fielding as |fielding index|}}
                <tr>
                  <td
        ...
        {{else if (eq @controller.selectedTab "pitching")}}
          <SortableTable
            class="player-table border-collapse border-none mb-4 mx-auto"
            @headers={{@controller.pitchingHeaders}}
            @items={{@model.seasonPitchingStats}}
          >
            <:header as |h|>
              <h.Header
                class="border-none
            ...
            <:default>
              <tr>
                ...
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.wins}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.losses}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.winPercentage}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.gamesStarted}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.inningsPitched}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.strikeOuts}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.baseOnBalls}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.hitByPitch}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.era}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.whip}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.strikeoutsPer9Inn}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.strikeoutWalkRatio}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.saves}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.completeGames}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.shutouts}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.battersFaced}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.airOuts}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.groundOuts}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.groundOutsToAirouts}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.numberOfPitches}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.pitchesPerInning}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.hitsPer9Inn}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.runsScoredPer9}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.homeRunsPer9}}</td>
                <td
                  class="py-1 px-2 sm:px-3"
                >{{@model.careerStats.pitching.stat.walksPer9Inn}}</td>
              </tr>
            </:default>
          </SortableTable>
        {{/if}}
